...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True, num_threads=2):
        # Usage:
        #   PyTorch:              weights = *.pt
        ...
        pt, jit, onnx, xml, engine, coreml = self._model_type(w)  # get backend
    ...
    def warmup(self, imgsz=(1, 3, 640, 640)):
        ...
        warmup_types = self.pt, self.jit, self.onnx, self.engine
