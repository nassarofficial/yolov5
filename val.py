...
def run(
    ...
    if training:  # called by train.py
        ...
        # Load model
        model = DetectMultiBackend(weights, device=device, dnn=dnn, data=data, fp16=half, num_threads=num_threads)
...
def parse_opt():
    ...
    parser.add_argument('--num_threads', type=int, default=2, help='num threads')
    num_threads
